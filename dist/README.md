## Cloudeye JSON Datasource - a generic backend datasource
...
```
sudo grafana-cli plugins install grafana-cloudeye-json-datasource
sudo service grafana-server restart
```
See [here](https://grafana.com/plugins/grafana-cloudeye-json-datasource/installation) for more
information.

### Example backend implementations
- https://github.com/bergquist/fake-cloudeye-json-datasource
...
NOTE!
for grafana 2.6 please use [this version](https://github.com/grafana/cloudeye-json-datasource/commit/b78720f6e00c115203d8f4c0e81ccd3c16001f94)
