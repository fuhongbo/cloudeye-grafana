...
var GenericDatasourceQueryCtrl = exports.GenericDatasourceQueryCtrl = function (_QueryCtrl) {
  ...
  function GenericDatasourceQueryCtrl($scope, $injector) {
    ...
    _this.target.project = _this.target.project || 'ces_project';
    _this.target.metric = _this.target.metric || 'ces_metric';
    return _this;
  }
  ...
  _createClass(GenericDatasourceQueryCtrl, [{
    ...
    value: function getOptions(query) {
        if (this.target.project && this.target.metric) {
            return this.datasource.metricFindQuery(query || '', this.target.project, this.target.metric);
        }
    }
  }, {
      key: 'getProjects',
